...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6446973137145">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6446973137145" data-allow-clear="true">
                    <option></option>
...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <!--begin::Form-->
<form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="listing.php">
    <!--begin::Aside column-->
    ...
    <div class="card-body pt-0">
        <div class="d-flex flex-column gap-10">
            ...
            <div class="fv-row">
                ...
                <div class="fw-bold fs-3">#12524</div>
                <!--end::Input-->
            </div>
            <!--end::Input group-->
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 border border-dashed rounded pt-3 pb-1 px-2 mb-5 mh-300px overflow-scroll" id="kt_ecommerce_edit_order_selected_products">
                    ...
                    <!--end::Empty message-->
                            ...
                            <div class="d-flex align-items-center border border-dashed p-3 rounded bg-white">
                                ...
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 25</a>
                                    <!--end::Title-->
                                    ...
                                    <!--begin::SKU-->
                                    <div class="text-muted fs-7">SKU: 02442009</div>
                                    <!--end::SKU-->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col my-2" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_98">
                            <div class="d-flex align-items-center border border-dashed rounded p-3 bg-white">
                                ...
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 98</a>
                                    <!--end::Title-->
                                    ...
                                    <!--begin::SKU-->
                                    <div class="text-muted fs-7">SKU: 03528008</div>
                                    <!--end::SKU-->
                                </div>
                            </div>
                        </div>
                ...
                <tbody class="fw-semibold text-gray-600">
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 1</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">295.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02810009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_2">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 2</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">78.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03546005</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_3">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 3</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">240.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04508006</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_4">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 4</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">192.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01230004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_5">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 5</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">61.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01188009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_6">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 6</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">216.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01816001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_7">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 7</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">157.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01288001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_8">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 8</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">100.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01472002</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_9">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 9</a>
                                        <!--end::Title-->
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02132004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_10">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 10</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">129.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01140009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_11">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 11</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">119.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01428004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_12">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 12</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">195.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01173008</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_13">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 13</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">277.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04987008</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_14">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 14</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">267.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04437002</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_15">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 15</a>
                                        <!--end::Title-->
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04248008</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_16">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 16</a>
                                        <!--end::Title-->
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03942005</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_17">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 17</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">152.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01967005</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_18">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 18</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">190.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03130004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_19">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 19</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">167.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04204004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_20">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 20</a>
                                        <!--end::Title-->
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_21">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 21</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">217.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01845006</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_22">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 22</a>
                                        <!--end::Title-->
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03391004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_23">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 23</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">123.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03804004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_24">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 24</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">293.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02874002</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">183.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01425004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_26">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 26</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">207.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01464001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_27">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 27</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">226.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01572001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_28">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 28</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">249.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03936007</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_29">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 29</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">143.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03674001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_30">
                                    ...
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 30</a>
                                        <!--end::Title-->

                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">153.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02945003</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
            ...
            <div class="fv-row">
                ...
                <select class="form-select" data-placeholder="Select an option" id="kt_ecommerce_edit_order_billing_country" name="billing_order_country">
                    <option></option>
                                            ...
                                            <option value="AU" data-kt-select2-country="/metronic8/demo1/assets/media/flags/australia.svg" selected>Australia</option>
...
<!--end::Order details-->
        <div class="d-flex justify-content-end">
            <!--begin::Button-->
            <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/products.php" id="kt_ecommerce_edit_order_cancel" class="btn btn-light me-5">
                Cancel
            </a>
            <!--end::Button-->
