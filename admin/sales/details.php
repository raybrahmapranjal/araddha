...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_64469730965b1">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_64469730965b1" data-allow-clear="true">
                    <option></option>
...
<div class="d-flex flex-column gap-7 gap-lg-10">
    ...
    <!--begin::Button-->
    <a href="listing.php" class="btn btn-icon btn-light btn-sm ms-auto me-lg-n7">
        <i class="ki-duotone ki-left fs-2"></i>    </a>
    <!--end::Button-->
    
    <!--begin::Button-->
    <a href="edit-order.php" class="btn btn-success btn-sm me-lg-n7">Edit Order</a>
    <!--end::Button-->

    <!--begin::Button-->
    <a href="add-order.php" class="btn btn-primary btn-sm">Add New Order</a>
    <!--end::Button-->
</div>
    <!--begin::Order summary-->
            ...
            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                <tbody class="fw-semibold text-gray-600">
                    <tr>
                        ...
                        <td class="fw-bold text-end">24/04/2023</td>
                    </tr>
                    <tr>
                        <td class="text-muted">
                            <div class="d-flex align-items-center">
                        ...
                        <td class="fw-bold text-end">
                            Online
                            <img src="https://preview./metronic8/demo1/assets/media/svg/card-logos/visa.svg" class="w-50px ms-2" />
                        </td>
                    </tr>
                    <tr>
                        <td class="text-muted">
                            <div class="d-flex align-items-center">
                                <i class="ki-duotone ki-truck fs-2 me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>                                Shipping Method
                            </div>
                        </td>
            ...
            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                <tbody class="fw-semibold text-gray-600">
                        ...
                        <td class="fw-bold text-end">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <div class="symbol symbol-circle symbol-25px overflow-hidden me-3">
                                    <a href="https://preview./metronic8/demo1/apps/ecommerce/customers/details.php">
                                ...
                                <!--begin::Name-->
                                <a href="https://preview./metronic8/demo1/apps/ecommerce/customers/details.php" class="text-gray-600 text-hover-primary">
                                    Dan Wilson                                </a>
                                <!--end::Name-->
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="fw-bold text-end">
                            <a href="https://preview./metronic8/demo1/apps/user-management/users/view.php" class="text-gray-600 text-hover-primary">
...
<span class="ms-1"  data-bs-toggle="tooltip" title="View the invoice generated by this order." >
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>                            </div>
                        </td>
                        <td class="fw-bold text-end"><a href="https://preview./metronic8/demo1/apps/invoices/view/invoice-3.php" class="text-gray-600 text-hover-primary">#INV-000414</a></td>
                    </tr>
                    <tr>
                        <td class="text-muted">
                            <div class="d-flex align-items-center">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="ms-5">
                                    <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="fw-bold text-gray-600 text-hover-primary">Product 1</a>
                                    <div class="fs-7 text-muted">Delivery Date: 24/04/2023</div>
                                </div>
                                <!--end::Title-->
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="ms-5">
                                    <a href="https://preview./metronic8/demo1/apps/ecommerce/catalog/edit-product.php" class="fw-bold text-gray-600 text-hover-primary">Footwear</a>
                                    <div class="fs-7 text-muted">Delivery Date: 24/04/2023</div>
                                </div>
                                <!--end::Title-->
                            </div>
