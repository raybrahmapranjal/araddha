...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_64469730e2925">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_64469730e2925" data-allow-clear="true">
                    <option></option>
    ...
    <div class="card-body pt-0">
        <div class="d-flex flex-column gap-10">
            ...
            <div class="fv-row">
                ...
                <div class="fw-bold fs-3">#13742</div>
                <!--end::Input-->
            </div>
            <!--end::Input group-->
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">75.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01824006</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_2">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01672009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_3">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02738008</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_4">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">53.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04368003</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_5">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">136.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01205001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_6">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03680006</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_7">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">211.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03688007</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_8">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">257.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01902005</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_9">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03823006</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_10">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">120.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04511003</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_11">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">182.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01645003</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_12">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">228.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03389009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_13">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">187.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03441009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_14">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02554006</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_15">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">287.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02322008</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_16">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">170.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03733008</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_17">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04101001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_18">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04378001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_19">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">41.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03135004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_20">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">65.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02822002</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_21">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04952003</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_22">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">27.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02405004</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_23">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">282.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02353001</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_24">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 03267009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">111.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02775009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_26">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">298.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 01347009</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_27">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">140.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04304007</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_28">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">236.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 04534006</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_29">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::Price-->
                                        <div class="fw-semibold fs-7">Price: $<span data-kt-ecommerce-edit-order-filter="price">103.00</span></div>
                                        <!--end::Price-->

                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02983002</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_30">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <!--begin::SKU-->
                                        <div class="text-muted fs-7">SKU: 02268003</div>
                                        <!--end::SKU-->
                                    </div>
                                </div>
                            </td>
