...
var KTModalOfferADealFinance = (function () {
  ...
  var initValidation = function () {
    ...
    KTDialer.getInstance(form.querySelector("#kt_modal_finance_setup")).on(
      "kt.dialer.changed",
      function () {
  ...
  return {
    ...
    init: function () {
      ...
      nextButton = KTModalOfferADeal.getStepper().querySelector(
        '[data-kt-element="finance-next"]'
      );
      previousButton = KTModalOfferADeal.getStepper().querySelector(
