...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_64469b95dc3fb">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_64469b95dc3fb" data-allow-clear="true">
                    <option></option>
...
<!--end::Menu-->    </div>
    ...
    <span>
        <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-placement="top" title="Sort">
            <i class="ki-duotone ki-dots-square fs-3 m-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>        </a>
        <!--begin::Menu-->
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    <!--begin::Menu item-->
    <div class="menu-item px-3">
...
<table class="table table-hover table-row-dashed fs-6 gy-5 my-0" id="kt_inbox_listing">
    ...
    <tbody>
                ...
                <td class="w-150px w-md-175px">
                    <a href="reply.php" class="d-flex align-items-center text-dark">
                        <!--begin::Avatar-->
                ...
                <td>
                    <div class="text-dark gap-1 pt-2">
                        <!--begin::Heading-->
                        <a href="reply.php" class="text-dark">
