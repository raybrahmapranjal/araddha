...
<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
    ...
    <li class="menu-item"><a href="https://devs./" target="_blank" class="menu-link px-2">Support</a></li>
...
<!--end::Card header-->
		...
		<div class="card-body position-relative" id="kt_app_layout_builder_body">
			...
			<div id="kt_app_settings_content" 
				...
				<!--begin::Form-->
				<form class="form" method="POST" id="kt_app_layout_builder_form" action="https://preview./metronic8/demo1/index.php">
...
<div class="form-group">
	...
	<div class="mb-6">
		...
		<div class="fw-semibold text-muted fs-7 d-block lh-1">
			...
			<a class="fw-semibold" href="https://preview./html/metronic/docs/getting-started/dark-mode" target="_blank">See docs</a>
		</div>
	</div>
	<!--end::Heading-->  
...
<div class="form-group d-flex flex-stack">           
	...
	<div class="d-flex flex-column">
		...
		<div class="fs-7 fw-semibold text-muted">
			...
			<a class="fw-semibold" href="https://preview./html/metronic/docs/getting-started/rtl" target="_blank">See docs</a>
		</div>	
	</div>
	<!--end::Heading-->
...
<div class="form-group ">            
	...
	<div class="d-flex flex-column mb-4">
		...
		<div>
			...
			<a class="fw-semibold" href="https://preview./html/metronic/docs/icons/keenicons" target="_blank">Learn more</a>
		</div>
	</div>
	<!--end::Heading-->
...
<div class="form-group">
	...
	<div class="mb-6">
		...
		<a href="https://preview./metronic8/demo1/layout-builder.php" class="fw-semibold text-primary">More layout options</a>
	</div>
	<!--end::Heading-->                  
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="overflow-auto pb-5">
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">  
                <!--begin::Title-->                                   
                <a href="https://preview./metronic8/demo1/apps/projects/project.php" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>                                  
                <!--end::Title-->
                ...
                <!--begin::Action-->
                <a href="https://preview./metronic8/demo1/apps/projects/project.php" class="btn btn-sm btn-light btn-active-light-primary">View</a>    
                <!--end::Action-->                                
            </div>
            <!--end::Record-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">  
                <!--begin::Title-->                                   
                <a href="https://preview./metronic8/demo1/apps/projects/project.php" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>                                  
                <!--end::Title-->
        ...
        <div class="overflow-auto pb-5">
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">  
                    <!--begin::Icon-->                                  
                    <img alt="" class="w-30px me-3" src="https://preview./metronic8/demo1/assets/media/svg/files/pdf.svg"/>
                    <!--end::Icon--> 

                    <!--begin::Info--> 
                    <div class="ms-1 fw-semibold">
                        <!--begin::Desc--> 
                        <a href="https://preview./metronic8/demo1/apps/projects/project.php" class="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
                        <!--end::Desc--> 
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    <!--begin::Icon-->                                  
                    <img alt="/metronic8/demo1/../demo1/apps/projects/project.php" class="w-30px me-3" src="https://preview./metronic8/demo1/assets/media/svg/files/doc.svg"/>
                    <!--end::Icon--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    <!--begin::Icon-->                                  
                    <img alt="/metronic8/demo1/../demo1/apps/projects/project.php" class="w-30px me-3" src="https://preview./metronic8/demo1/assets/media/svg/files/css.svg"/>
                    <!--end::Icon--> 
...
<!--end::Timeline item--> 				</div>
		...
		<div class="card-footer py-5 text-center" id="kt_activities_footer">
			<a href="https://preview./metronic8/demo1/pages/user-profile/activity.php" class="btn btn-bg-body text-primary">
...
<!--end::Menu 3-->
    ...
    <div class="d-flex justify-content-start mb-10 " >
        ...
        <div class="d-flex flex-column align-items-start">
            ...
            <!--begin::Text-->
            <div class="p-5 rounded bg-light-info text-dark fw-semibold mw-lg-400px text-start" data-kt-element="message-text">
                You can unwatch this repository immediately by clicking here: <a href=""></a>            </div>
            <!--end::Text-->
        </div>
        <!--end::Wrapper-->
    </div>
        ...
        <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D Printer</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/index.php" 
	data-kt-href="true" 
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo2/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo30/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo39/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo31/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo27/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo6/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo3/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo23/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo38/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo36/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo10/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo35/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo8/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo25/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo20/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo7/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo50/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo32/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo42/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo44/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo33/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo37/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo11/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo16/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo26/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo22/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo19/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo40/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo29/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo24/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo4/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo41/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo18/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo21/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo34/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo15/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo14/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo9/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo5/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo13/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo12/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo48/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo28/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo17/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo49/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo43/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo45/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo47/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo46/index.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/marketing.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/social.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/ecommerce.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/store-analytics.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/logistics.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/delivery.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/online-courses.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/school.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/crypto.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/finance-performance.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/website-analytics.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/bidding.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/podcast.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/projects.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/call-center.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/dashboards/pos.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/projects/list/list.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/customers/list/list.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/subscriptions/list/list.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/user-management/users/list/list.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/invoices/create/main.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/support-center/overview/main.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/chat/private.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/calendar/calendar.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/file-manager/list/folders.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/inbox/listing/listing.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/apps/contacts/getting-started.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/layouts/corporate/sign-in.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/layouts/creative/sign-in.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/layouts/fancy/sign-in.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/layouts/overlay/sign-in.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/extended/multi-steps-sign-up.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/layouts/corporate/two-factor.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/general/password-confirmation.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/general/verify-email.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/general/welcome.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/general/coming-soon.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/general/account-deactivated.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/general/error-404.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/general/error-500.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/user-profile/overview.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/user-profile/projects.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/user-profile/campaigns.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/user-profile/documents.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/user-profile/followers.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/user-profile/activity.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/about.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/contact.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/licenses.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/team.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/sitemap.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/social/feeds.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/social/activity.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/social/followers.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/social/settings.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/faq/classic.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/faq/extended.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/blog/home.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/pages/blog/post.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/overview.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/settings.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/billing.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/security.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/referrals.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/logs.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/api-keys.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/account/statements.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/general/view-users.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/general/upgrade-plan.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/wizards/top-up-wallet.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/general/share-earn.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/general/select-users.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/forms/bidding.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/wizards/offer-a-deal.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/forms/new-target.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/forms/new-card.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/forms/new-address.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/general/invite-friends.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/wizards/create-project.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/wizards/create-campaign.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/wizards/create-account.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/wizards/create-app.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/forms/create-api-key.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/modals/wizards/two-factor-authentication.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/wizards/horizontal.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/wizards/vertical.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/search/users.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/search/horizontal.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/search/vertical.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/utilities/search/select-location.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/widgets/charts.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/widgets/feeds.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/widgets/lists.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/widgets/mixed.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/widgets/statistics.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/widgets/tables.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/email/welcome-message.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/email/subscription-confirmed.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/email/reset-password.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/email/card-declined.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/email/promo-1.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/email/promo-2.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="https://preview./metronic8/demo1/authentication/email/promo-3.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/index.php">
				Metronic Original			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo2/index.php">
				SaaS App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo30/index.php">
				Sales Tracking App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo39/index.php">
				Billing SaaS			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo31/index.php">
				Marketing Automation			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo27/index.php">
				Databox Dashboard			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo6/index.php">
				Time Reporting			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo3/index.php">
				New Trend			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo23/index.php">
				Member Dashboard			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo38/index.php">
				Email Marketing			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo36/index.php">
				Digital Marketing			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo10/index.php">
				Project Grid			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo35/index.php">
				Traffic Analytics			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo8/index.php">
				Analytics App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo25/index.php">
				User Guiding App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo20/index.php">
				CRM Software			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo7/index.php">
				CRM Dashboard			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo50/index.php">
				Micro-SaaS App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo32/index.php">
				Delivery Management			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo42/index.php">
				Calendar Workspace			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo44/index.php">
				Recruit Automation			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo33/index.php">
				Social Campaings			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo37/index.php">
				Cloud Suite			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo11/index.php">
				Finance Planner			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo16/index.php">
				Podcast App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo26/index.php">
				Planable App			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo22/index.php">
				Media Publisher			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo19/index.php">
				Reports Panel			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo40/index.php">
				HR App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo29/index.php">
				Project Workspace			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo24/index.php">
				Helpdesk App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo4/index.php">
				Jobs Site			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo41/index.php">
				Business Intelligence			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo18/index.php">
				Goal Tracking			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo21/index.php">
				Monochrome App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo34/index.php">
				Finance Analytics			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo15/index.php">
				Crypto Planner			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo14/index.php">
				Project Workplace			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo9/index.php">
				Sales Manager			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo5/index.php">
				Support Forum			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo13/index.php">
				Classic Dashboard			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo12/index.php">
				Data Analyzer			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo48/index.php">
				Cloud ERP			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo28/index.php">
				eCommerce App			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo17/index.php">
				Events Scheduler			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo49/index.php">
				KPI Tracking			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo43/index.php">
				Healthcare Dashboard			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo45/index.php">
				OKR Tracking			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo47/index.php">
				Campaign Automation			</a>

					
		
			
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo46/index.php">
				Audit Board App			</a>
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/marketing.php">
				Marketing Dashboard			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/social.php">
				Social Dashboard			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/ecommerce.php">
				eCommerce Dashboard			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/store-analytics.php">
				Store Analytics			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/logistics.php">
				Logistics			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/delivery.php">
				Delivery			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/online-courses.php">
				Online Courses			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/school.php">
				Hello Tyler			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/crypto.php">
				My Balance: 37,045$			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/finance-performance.php">
				Finance Performance			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/website-analytics.php">
				Website Analytics			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/bidding.php">
				Bidding Dashboard			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/podcast.php">
				Podcast Dashboard			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/projects.php">
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/call-center.php">
				Call Center			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/dashboards/pos.php">
				POS System			</a>
...
<!--end::Row-->		
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/layouts/corporate/sign-in.php">
						Corporate					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/layouts/creative/sign-in.php">
						Creative					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/layouts/fancy/sign-in.php">
						Fancy					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/layouts/overlay/sign-in.php">
						Overlay					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/extended/multi-steps-sign-up.php">
						Multi-Step					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/layouts/corporate/two-factor.php">
						Two-Factor					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/general/password-confirmation.php">
						Password Changed					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/general/verify-email.php">
						Verify Email					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/general/welcome.php">
						Welcome					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/general/coming-soon.php">
						Coming Soon					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/general/account-deactivated.php">
						Account Deactivated					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/general/error-404.php">
						404 Page					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/general/error-500.php">
						505 Page					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/overview.php">
						Overview					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/settings.php">
						Settings					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/billing.php">
						Billing					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/security.php">
						Security					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/referrals.php">
						Referrals					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/logs.php">
						Logs					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/api-keys.php">
						API Keys					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/account/statements.php">
						Statements					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/general/view-users.php">
						View Friends					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/general/upgrade-plan.php">
						Upgrade Plan					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/wizards/top-up-wallet.php">
						Topup Wallet					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/general/share-earn.php">
						Share & Earn					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/general/select-users.php">
						Select User					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/forms/bidding.php">
						Place Bid					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/wizards/offer-a-deal.php">
						Offer Deal					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/forms/new-target.php">
						New Target					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/forms/new-card.php">
						New Card					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/forms/new-address.php">
						New Address					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/general/invite-friends.php">
						Invite Friend					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/wizards/create-project.php">
						Create Project					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/wizards/create-campaign.php">
						Create Campaign					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/wizards/create-account.php">
						Create Business Account					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/wizards/create-app.php">
						Create App					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/forms/create-api-key.php">
						Create Api Key					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/modals/wizards/two-factor-authentication.php">
						2 Factor Auth					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/wizards/horizontal.php">
						2 Factor Auth					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/wizards/vertical.php">
						Vertical					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/search/users.php">
						Search Users					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/search/horizontal.php">
						Search Horizontal					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/search/vertical.php">
						Search Vertical					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/utilities/search/select-location.php">
						Search Location					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/widgets/charts.php">
						Charts					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/widgets/feeds.php">
						Feeds					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/widgets/lists.php">
						Lists					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/widgets/mixed.php">
						Mixed					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/widgets/statistics.php">
						Statistics					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/widgets/tables.php">
						Tables					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/email/welcome-message.php">
						Welcome					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/email/subscription-confirmed.php">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/email/reset-password.php">
						Reset Password					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/email/card-declined.php">
						Card Declined					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/email/promo-1.php">
						Promotion 1					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/email/promo-2.php">
						Promotion 2					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/authentication/email/promo-3.php">
						Promotion 3					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/user-profile/overview.php">
						Profile Overview					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/user-profile/projects.php">
						User Projects					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/user-profile/campaigns.php">
						User Campaigns					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/user-profile/documents.php">
						User Documents					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/user-profile/followers.php">
						User Followers					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/user-profile/activity.php">
						User Activity					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/about.php">
						About Us					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/contact.php">
						Contact Us					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/licenses.php">
						License					</a>

											
				
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/team.php">
						Our Team					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/sitemap.php">
						Sitemap					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/social/feeds.php">
						Activity					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/social/activity.php">
						Feeds					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/social/followers.php">
						Followers					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/social/settings.php">
						Settings					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/faq/classic.php">
						FAQ Classic					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/faq/extended.php">
						FAQ Extended					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/blog/home.php">
						Blog Home					</a>
					...
					<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/pages/blog/post.php">
						Blog Post					</a>
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/projects/list/list.php">
				Projects			</a>

					
		
			<a class="fw-6 fw-semibold" href="products/products.php">
				Ecommerce			</a>

					
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/customers/list/list.php">
				Customers			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/subscriptions/list/list.php">
				Subscriptions			</a>

					
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/user-management/users/list/list.php">
				User Management			</a>

					
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/invoices/create/main.php">
				Invoices			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/support-center/overview/main.php">
				Support Center			</a>

					
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/chat/private.php">
				Chat			</a>

					
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/calendar/calendar.php">
				Calendar			</a>
			...
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/file-manager/list/folders.php">
				File Manager			</a>

					
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/inbox/listing/listing.php">
				Inbox			</a>

					
		
			<a class="fw-6 fw-semibold" href="https://preview./metronic8/demo1/apps/contacts/getting-started.php">
				Contacts			</a>
...
<div class="d-flex flex-column mb-7 fv-row">
    ...
    <div class="position-relative">
        ...
        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
            <img src="https://preview./metronic8/demo1/assets/media/svg/card-logos/visa.svg" alt="" class="h-25px"/>
            <img src="https://preview./metronic8/demo1/assets/media/svg/card-logos/mastercard.svg" alt="" class="h-25px"/>
            <img src="https://preview./metronic8/demo1/assets/media/svg/card-logos/american-express.svg" alt="" class="h-25px"/>
        </div>
        <!--end::Card logos-->
    </div>
    <!--end::Input wrapper-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="https://preview./metronic8/demo1/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3"/>
...
<!--end::Modal - Invite Friend-->            <!--end::Modals-->
        ...
        <!--begin::Javascript-->
        <script>
            var hostUrl = "https://preview./metronic8/demo1/assets/";        </script>
...
<!-- Mirrored from preview./metronic8/demo1/apps/ecommerce/catalog/products.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 14:47:39 GMT -->
</html>