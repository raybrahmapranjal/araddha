...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_644698382c7c4">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_644698382c7c4" data-allow-clear="true">
                    <option></option>
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-5"><span class="path1"></span><span class="path2"></span></i>                <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Customers" />
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
...
<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
    ...
    <tbody class="fw-semibold text-gray-600">
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                </td>
                <td>
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <a href="https://preview./metronic8/demo1/apps/customers/view.php" class="menu-link px-3">
            View
        </a>
    </div>
    <!--end::Menu item-->
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="details.php" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
                </td>
                <td>
...
<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="https://preview./metronic8/demo1/apps/customers/list.php">
                <!--begin::Modal header-->
