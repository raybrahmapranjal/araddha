...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6446983cdb9f6">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6446983cdb9f6" data-allow-clear="true">
                    <option></option>
...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-body pt-15">
        ...
        <div class="pb-5 fs-6">
                ...
                <div class="text-gray-600"><a href="#" class="text-gray-600 text-hover-primary">info@</a></div>
                <!--begin::Details item-->
                            <!--begin::Details item-->
                ...
                <div class="text-gray-600"><a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary">#14534</a> </div>
                <!--begin::Details item-->
                    </div>
        <!--end::Details content-->
    </div>
    ...
    <div class="card-body pt-0 pb-5">
        ...
        <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
            ...
            <tbody class="fs-6 fw-semibold text-gray-600">
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15078</a>
                        </td>
                        <td>
                        ...
                        <td>
                            14 Dec 2020, 8:43 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15067</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            01 Dec 2020, 10:12 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15662</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            12 Nov 2020, 2:01 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15036</a>
                        </td>
                        <td>
                        ...
                        <td>
                            21 Oct 2020, 5:54 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15458</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            19 Oct 2020, 7:32 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#14935</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            23 Sep 2020, 12:38 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#14710</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            11 Sep 2020, 3:18 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15631</a>
                        </td>
                        <td>
                        ...
                        <td>
                            03 Sep 2020, 1:08 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/ecommerce/sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15441</a>
                        </td>
                        <td>
                            <span class="badge badge-light-warning">Pending</span>
                        </td>
            ...
            <div class="row row-cols-1 row-cols-md-2">
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--begin::Input-->
                        <input type="email" class="form-control form-control-solid" placeholder="" name="bill_email" value="info@" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                </div>
    ...
    <div class="card-header border-0">
        ...
        <div class="card-toolbar">
            <a href="#" class="btn btn-sm btn-flex btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_address">
                <i class="ki-duotone ki-plus-square fs-3"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i> Add new address
            </a>
        </div>
        <!--end::Card toolbar-->
    </div>
            ...
            <div class="py-0" data-kt-customer-payment-method="row">
                ...
                <div class="py-3 d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center collapsible  rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
                        ...
                        <!--begin::Logo-->
                        <img src="https://preview./metronic8/demo1/assets/media/svg/card-logos/mastercard.svg" class="w-40px me-3" alt="" />
                        <!--end::Logo-->
                    ...
                    <div class="d-flex flex-wrap py-5">
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">**** 1705</td>
                                    </tr>
                                                                    <tr>
                            ...
                            <div class="flex-equal ">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Australia <div class="symbol symbol-20px symbol-circle ms-2"><img src="https://preview./metronic8/demo1/assets/media/flags/australia.svg" /></div></td>
                                    </tr>
                                                                    <tr>
            ...
            <div class="py-0" data-kt-customer-payment-method="row">
                ...
                <div class="py-3 d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_2" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_2">
                        ...
                        <!--begin::Logo-->
                        <img src="https://preview./metronic8/demo1/assets/media/svg/card-logos/visa.svg" class="w-40px me-3" alt="" />
                        <!--end::Logo-->
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Melody Macy</td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                        <td class="text-gray-800">**** 6917</td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                            ...
                            <div class="flex-equal ">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800"><a href="#" class="text-gray-900 text-hover-primary">melody@altbox.com</a></td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Origin</td>
                                        <td class="text-gray-800">United Kingdom <div class="symbol symbol-20px symbol-circle ms-2"><img src="https://preview./metronic8/demo1/assets/media/flags/united-kingdom.svg" /></div></td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">CVC check</td>
            ...
            <div class="py-0" data-kt-customer-payment-method="row">
                ...
                <div class="py-3 d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_3" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_3">
                        ...
                        <!--begin::Logo-->
                        <img src="https://preview./metronic8/demo1/assets/media/svg/card-logos/american-express.svg" class="w-40px me-3" alt="" />
                        <!--end::Logo-->
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Max Smith</td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                        <td class="text-gray-800">**** 4404</td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                            ...
                            <div class="flex-equal ">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800"><a href="#" class="text-gray-900 text-hover-primary">max@kt.com</a></td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Origin</td>
                                        <td class="text-gray-800">United States of America <div class="symbol symbol-20px symbol-circle ms-2"><img src="https://preview./metronic8/demo1/assets/media/flags/united-states.svg" /></div></td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">CVC check</td>
