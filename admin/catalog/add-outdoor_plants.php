...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <!--begin::Select2-->
        <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_product_status_select" onChange="SelectRedirect();">
            <option>select option</option>
            <option value="published" selected>Indoor Plants</option>
            <option value="draft">Outdoor Plants</option>
            <option value="scheduled">Tree Saplings</option>
            <option value="inactive">Fruit Plants</option>
            <option value="inactive">Medicinal Plants</option>
            <option value="inactive">Gardening Tools</option>
        </select>
        <!--end::Select2-->
