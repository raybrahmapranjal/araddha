                          ...
                          <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                               ...
                                               <td><?php echo $slide['head'] ;?></td> 
                                               <td><?php echo $slide['title'] ;?></td> 
                                               
                                            <td><img width="100px"src="../<?php echo $slide['image'];?>"></td> 
                                            <td><a href="<?php echo  $slide['slider_id'] ;?>" data-id="<?php echo  $slide['slider_id'] ;?>"  class="btn btn-sm btn-icon btn-light btn-active-light-primary tblEditBtn toggle h-25px w-25px" data-kt-table-widget-4="expand_row"data-toggle="modal" data-target="#exampleModal">
                                    <i class="ki-duotone ki-message-edit fs-2 m-0"><span class="path1"></span><span class="path2"></span></i> 
                                  </a>
                                  <!--begin::Delete-->
                                  <a href="<?php echo  $slide['slider_id'] ;?>" 
                               data-id="<?php echo  $slide['slider_id'] ;?>"  class="btn btn-sm btn-icon btn-light btn-active-light-primary tblEditBtn toggle h-25px w-25px" data-kt-table-widget-4="expand_row"data-toggle="modal" data-target="#exampleModal">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">edit home slider</h5>
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="../form/edit_slider.php" method="post" enctype="multipart/form-data">
...
<div class="card card-flush py-4">
  <!--begin::Card body-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">head</label>
            <!--end::Label-->

            <!--begin::Input-->
                        <input type="text" name="head" id="head" class="form-control mb-2" placeholder="head" value="" />
            <!--end::Input-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        <input type="text" name="title" id="title" class="form-control mb-2" placeholder="title" value="" />
            <!--end::Input-->
...
<!--end::General options-->
        ...
        <div class="d-flex justify-content-end">
             <!--begin::Button-->
             <a href="" id="deleteSlider" class="btn btn-danger">DELETE <i class="fa fa-trash-o"></i></a>
            <!--end::Button-->

            <!--begin::Button-->
            <button type="submit" name="submitform" value="submit" id="kt_ecommerce_add_category_submit" class="btn btn-primary">
...
<script src="../assets/js/bootstrap.min.js"></script>
  ...
  $(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
        ...
        $('#deleteSlider').attr("href","../form/delete_slider.php?slider_id="+dataId);
         var imagePath = response.image.replace("/araddha/admin/catalog/images/index/", "../admin/image/index/");
    $('#responseImage').attr("src", imagePath);
