...
$subCat_id=$_GET['id'];
$cat_id=$_GET['id'];
 $readsub = $crud->Read("subcategories","`subCat_id`='$subCat_id'");
 $readcat = $crud->Read("categories","`cat_id`='$cat_id'");
}
?>
...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="../form/add_plants.php" method="post" enctype="multipart/form-data">
    <!--begin::Aside column-->
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
       
             <?php 
                            if($readsub){
                              $name=$readsub[0]['subCat_name'];
                              $catID=$readsub[0]['cat_id'];
                              $catName=$readsub[0]['cat_name'];
                              $sub_catID=$readsub[0]['subCat_id'];
...
placeholder="" class="form-control mb-2" value="<?php echo $catID;?>" />
                <!--end::Editor-->
            ...
            <div class="fv-row">
                ...
                <!--begin::Editor-->
                <input id="kt_ecommerce_edit_order_date" readonly name="cat_name"
placeholder="" class="form-control mb-2" value="<?php echo $catName;?>" />
                <!--end::Editor-->
            ...
            <div class="fv-row">
                <!--begin::Label-->
                <label class="required form-label">Sub-Category ID</label>
                <!--end::Label-->

                <!--begin::Editor-->
                <input id="kt_ecommerce_edit_order_date" readonly name="subCat_id"
placeholder="" class="form-control mb-2" value="<?php echo $sub_catID;?>" />
                <!--end::Editor-->

                <!--begin::Description-->
                <div class="text-muted fs-7">Your Plant SubCategory ID.</div>
                <!--end::Description-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="fv-row">
                ...
                <!--begin::Editor-->
                <input id="kt_ecommerce_edit_order_date" name="subCat_name"  placeholder="" class="form-control mb-2" value="<?php echo $name;?>"  />
                <!--end::Editor-->
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        <input type="text" name="plantname"class="form-control mb-2" placeholder="Product name" value="" />
            <!--end::Input-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        ...
                        <textarea id="bio" name="description" class="form-control mb-2"style="border-radius: 10px;"></textarea>
            <!--end::Input-->
