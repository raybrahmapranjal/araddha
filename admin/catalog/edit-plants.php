                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <!--begin::Item-->
                      <li class="breadcrumb-item text-muted">View Sub-Categories</li>
                      <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                  </div>
                        ...
                        <div class="card-body pt-2">
                          ...
                          <table id="example" class="display wrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        if ($plants) {
                                            $n=0;
                                            foreach ($plants as $view_plants) { ?>
                                        <tr>
                                               <td><?php echo $view_plants['plant_id'] ;?></td> 
                                               <td><?php echo $view_plants['cat_id'] ;?></td> 
                                               <td><?php echo $view_plants['category'] ;?></td> 
                                               <td><?php echo $view_plants['subCat_id'] ;?></td> 
                                               <td><?php echo $view_plants['subcategories'] ;?></td> 
                                               <td><?php echo $view_plants['plantname'] ;?></td> 
                                               <td><?php echo $view_plants['description'] ;?></td> 
                                            <td><img height="100px" width="100px" src="<?php echo $view_plants['image1'];?>"></td> 
                                            <td><img height="100px" width="100px" src="<?php echo $view_plants['image2'];?>"></td>
                                             <td><img height="100px" width:"100px" src="<?php echo $view_plants['image3'];?>"></td>
                                            <td><?php echo $view_plants['price'] ;?></td>   
                                            <td><?php echo $view_plants['discount_price'] ;?></td>   
                                            <td><?php echo $view_plants['status'] ;?></td>   
                                            <td><?php echo $view_plants['date_uploaded'] ;?></td>   <td><a href="<?php echo  $view_plants['plant_id'] ;?>" data-id="<?php echo  $view_plants['plant_id'] ;?>"  class="btn btn-sm btn-icon btn-light btn-active-light-primary tblEditBtn toggle h-25px w-25px" data-kt-table-widget-4="expand_row"data-toggle="modal" data-target="#exampleModal">
                                    <i class="ki-duotone ki-message-edit fs-2 m-0"><span class="path1"></span><span class="path2"></span></i> 
                                  </a>
                                  <!--begin::Delete-->
                                  <a href="<?php echo  $view_plants['plant_id'] ;?>" 
                               data-id="<?php echo  $view_plants['plant_id'] ;?>"  class="btn btn-sm btn-icon btn-light btn-active-light-primary tblEditBtn toggle h-25px w-25px" data-kt-table-widget-4="expand_row"data-toggle="modal" data-target="#exampleModal">
                                      <i class="ki-duotone ki-trash fs-2 m-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>    </a></td>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">edit plants</h5>
        <button type="button" class="ki-duotone ki-cross fs-1" data-dismiss="modal" aria-label="Close">
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="../form/edit-plant.php" method="post" enctype="multipart/form-data">
  ...
  <!--begin::Card body-->
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        <input type="text" id="aboutID" name="aboutID" class="form-control mb-2" placeholder="Product name"  value="" />
            <!--end::Input-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">Plant Name</label>
            <!--end::Label-->

            <!--begin::Input-->
                        <input type="text" name="plantname" id="plantname" class="form-control mb-2" placeholder="plant name" value="" />
            <!--end::Input-->

            <!--begin::Description-->
            <div class="text-muted fs-7">A plant name is required and recommended to be unique.</div>
            <!--end::Description-->
        </div>
        <!--end::Input group-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        <input type="text" name="category" id="category" class="form-control mb-2" placeholder="plant name" value="" />
            <!--end::Input-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        ...
                        <textarea id="description" name="description" class="form-control mb-2"style="border-radius: 10px;"></textarea>
            <!--end::Input-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">Image1</label>
            <!--end::Label-->

            <!--begin::Input-->
                       
                        <input type="file" name="image1" id="image1" accept="image/*" class="dropzone">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">Image2</label>
            <!--end::Label-->
<input type="file" name="image2" id="image2" accept="image/*" class="dropzone">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">Image3</label>
            <!--end::Label-->
<input type="file" name="image3" id="image3" accept="image/*" class="dropzone">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Description-->
            <div class="text-muted fs-7">A status is required and recommended to be unique.</div>
            <!--end::Description-->
        </div>
        <!--end::Input group-->
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
            <input type="text" name="price" id="price" class="form-control mb-2" placeholder="Product price" value="" />
            <!--end::Input-->
            ...
            <!--begin::Input-->
            <input type="text" name="discount_price" id="discount_price" class="form-control mb-2" placeholder="Product price" value="" />
            <!--begin::Description-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">date uploaded</label>
            <!--end::Label-->

            <!--begin::Input-->
                        <input type="text" name="dateuploaded" id="date_uploaded" class="form-control mb-2" placeholder="uploaded date" value="" />
            <!--end::Input-->
...
<!--end::General options-->
        ...
        <div class="d-flex justify-content-end">
             <!--begin::Button-->
             <a href="" id="deletePlant" class="btn btn-danger">DELETE <i class="fa fa-trash-o"></i></a>
            <!--end::Button-->
...
<script src="../assets/js/bootstrap.min.js"></script>
  ...
  $(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "../fetch/fetch_plants.php", 
         data: {
            dataId:dataId         
         },
         success: function(response){
          var keyed = response.plantname.replace(/<br ?\/?>/g,"\n");
        $("#plantname").val(keyed);
        var keyed = response.category.replace(/<br ?\/?>/g,"\n");
        $("#category").val(keyed);
        var keyed = response.description.replace(/<br ?\/?>/g,"\n");
        $("#description").val(keyed);
        var keyed = response.status.replace(/<br ?\/?>/g,"\n");
        $("#status").val(keyed);
        var keyed = response.price.replace(/<br ?\/?>/g,"\n");
        $("#price").val(keyed);
        var keyed = response.discount_price.replace(/<br ?\/?>/g,"\n");
        $("#discount_price").val(keyed);
        var keyed = response.date_uploaded.replace(/<br ?\/?>/g,"\n");
        $("#date_uploaded").val(keyed);
        $('#deletePlant').attr("href","../form/delete_plant.php?plant_id="+dataId);
...
$("#image1, #image2, #image3").change(function() {
  readURL(this);
});
