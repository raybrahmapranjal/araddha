...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6446964e355be">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6446964e355be" data-allow-clear="true">
                    <option></option>
...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <!--begin::Form-->
<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="products.php">
    <!--begin::Aside column-->
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <!--begin::Button-->
        <a href="add-category.php" class="btn btn-light-primary btn-sm mb-10">
    ...
    <div class="card-body pt-0">
        ...
        <table class="table table-row-dashed fs-6 gy-5 my-0" id="kt_ecommerce_add_product_reviews">
            ...
            <tbody>
                        ...
                        <td>
                            <a href="https://preview./metronic8/demo1/apps/inbox/reply.php" class="d-flex text-dark text-gray-800 text-hover-primary">
                                <!--begin::Avatar-->
