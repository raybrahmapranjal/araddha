                        ...
                        <div class="card-body pt-2">
                          ...
                          <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                      ...
                                      { ?>
                                        <tr>
                                          <td><?php echo $view_cat['cat_id'] ;?></td>
                                          <td><?php echo $view_cat['cat_name'] ;?></td>
                                          <td><span
                                    class="badge py-3 px-4 fs-7 badge-light-warning"
                                    ><?php echo $view_cat['status'] ;?></span></td>
                                          <td><a href="add-subcat.php?id=<?php echo $view_cat['cat_id'] ;?>"class="btn btn-sm fw-bold btn-success"
                                            >
                                              Add
                                            </a></td>
                                        </tr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">add sub-categories</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="../form/add_subCat.php" method="post" enctype="multipart/form-data">
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        <input type="text" id="cat_name" name="cat_name" class="form-control mb-2" placeholder="Product name" value="" />
            <!--end::Input-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">add subcategories</label>
            <!--end::Label-->

            <!--begin::Input-->
                        <input type="text" id="subCat_name" name="subCat_name" class="form-control mb-2" placeholder="subcategory name" value="" />
            <!--end::Input-->
...
<!--end::General options-->
      ...
      <div class="modal-footer">
        <a href="../form/add_subCat" type="submit" name="add_subCat" class="btn btn-primary" data-dismiss="modal">add</a>
