...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6446964dbc8d4">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6446964dbc8d4" data-allow-clear="true">
                    <option></option>
...
<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
    ...
    <tbody class="fw-semibold text-gray-600">
                ...
                <td>
                    <div class="d-flex">
                        <!--begin::Thumbnail-->
                        <a href="edit-category.php" class="symbol symbol-50px">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Computers</a>
                            <!--end::Title-->
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <a href="add-category.php" class="menu-link px-3">
            Edit
        </a>
    </div>
    <!--end::Menu item-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Watches</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Headphones</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Footwear</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Cameras</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Shirts</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Household</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Toys</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Handbags</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Wines</a>
                            <!--end::Title-->
...
<!--end::Menu-->
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="edit-category.php" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Sandals</a>
                            <!--end::Title-->
