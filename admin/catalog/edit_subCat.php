                      ...
                      <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body pt-2">
                          ...
                          <table id="example" class="display nowrap" style="width:100%">
                              ...
                              if ($sub) {
                              $n=0;
                              foreach ($sub as $view_subcat) 
                              { ?>
                                        <tr>
                                             <td><?php echo $view_subcat['subCat_id'] ;?></td>  
                                             <td><?php echo $view_subcat['cat_id'] ;?></td>  
                                             <td><?php echo $view_subcat['cat_name'] ;?></td>  
                                             <td><?php echo $view_subcat['subCat_name'] ;?></td>  
                                               
                                             <td><span
                                    class="badge py-3 px-4 fs-7 badge-light-warning"
                                    ><?php echo $view_subcat['status'] ;?></td> </span>
                                             <td >

                                  <a href="<?php echo $view_subcat['subCat_id'] ;?>" data-id="<?php echo $view_subcat['subCat_id'] ;?>"  class="btn btn-sm btn-icon btn-light btn-active-light-primary tblEditBtn toggle h-25px w-25px" data-kt-table-widget-4="expand_row"data-toggle="modal" data-target="#exampleModal">
                                    <i class="ki-duotone ki-message-edit fs-2 m-0"><span class="path1"></span><span class="path2"></span></i> 
                                  </a>
                                  <!--begin::Delete-->
                                  <a href="<?php echo $view_subcat['subCat_id'] ;?>" 
                               data-id="<?php echo $view_subcat['subCat_id'] ;?>"  class="btn btn-sm btn-icon btn-light btn-active-light-primary tblEditBtn toggle h-25px w-25px" data-kt-table-widget-4="expand_row"data-toggle="modal" data-target="#exampleModal">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">edit subcategories</h5>
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="../form/edit-subCategory.php" method="post" enctype="multipart/form-data">
  ...
  <!--begin::Card body-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        <input type="text" name="subCat_name" id="subCat_name" class="form-control mb-2" placeholder="Product name" value="" />
            <!--end::Input-->
...
<!--end::General options-->
  ...
  $(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "../fetch/fetch_subCat.php", 
         data: {
            dataId:dataId         
         },
         success: function(response){
          var keyed = response.subCat_name.replace(/<br ?\/?>/g,"\n");
       
        $("#subCat_name").val(keyed);
        var keyed = response.status.replace(/<br ?\/?>/g,"\n");
        $("#status").val(keyed);
        $('#deleteCat').attr("href","../form/delete_subCat.php?subCat_id="+dataId);
