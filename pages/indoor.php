...
<?php 
   ...
   if (isset($_GET['id'])) {
       $id = $_GET['id'];
       $indoor = $crud->Read("plants", "`cat_id` = $id LIMIT $start, $itemsPerPage");
   }
   
   $totalItems = $crud->Count("plants", "`cat_id` = $id");
   $totalPages = ceil($totalItems / $itemsPerPage);
   ?>
<?php 
   if($indoor){
     $name=$indoor[0]['category'];
      ...
      <div class="row">
         <div class="col-12">
            ...
            <div class="row shop_wrapper grid_4">
               <?php if($indoor){
                  foreach($indoor as $inKey){
                       $indoor1=$inKey['image1'];
                       $indoor2=$inKey['plantname'];
                       $indoor3=$inKey['price'];
                       $indoor4=$inKey['discount_price'];
                       $indoor5=$inKey['description'];
                  ...
                  <article class="single_product">
                     <figure>
                        <div class="product_thumb">
                           <a class="primary_img" href="product-details.php?plant_id=<?php echo $inKey['plant_id']?>"><img
                              src="../admin/images/<?php echo $indoor1?>" alt="" class="imgsize"></a>
                        </div>
                        <div class="product_content grid_content">
                           <div class="product_price_rating">
                              <h4 class="product_name"><a href="product-details.php?plant_id=<?php echo $inKey['plant_id']?>"><?php echo $indoor2?></a></h4>
                              <div class="price_box">
                                 <span class="current_price">Rs. <?php echo $indoor4?></span>
                                 <span class="old_price">Rs. <?php echo $indoor3?></span>
                              </div>
                           </div>
                        </div>
            ...
            <div class="shop_toolbar t_bottom">
               <div class="pagination">
                  <ul>
                     <?php 
                        if ($page > 1) {
                            echo '<li><a href="?id='.$id.'&page='.($page - 1).'">&lt;</a></li>';
                        }
                        
                        for ($i = 1; $i <= $totalPages; $i++) {
                            echo '<li '.($page == $i ? 'class="current"' : '').'><a href="?id='.$id.'&page='.$i.'">'.$i.'</a></li>';
                        }
